...
function setup() {
  ...
  console.log(brokenboatSpriteData.frames)
  for (let index = 0; index < brokenboatFrames.length; index++) {
    var pos = brokenboatFrames[index].frame
  ...
  console.log(watersplashSpriteData.frames)
  for (let index = 0; index < watersplashFrames.length; index++) {
    var pos = watersplashFrames[index].frame
